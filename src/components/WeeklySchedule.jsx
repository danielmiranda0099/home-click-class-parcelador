...
const weekDays = [
  ...
  { day: "Mi", hours: ["7:00am"] },
  { day: "Ju", hours: ["2:00pm"] },
  { day: "Vi", hours: ["8:00am", "10:00am", "11:00am", "8:00am", "10:00am", "11:00am", "8:00am", "10:00am", "11:00am"] },
  { day: "Sa", hours: [] },
  { day: "Do", hours: [] },
];
...
function DaySchedule({ day, hours, isLast }) {
  return (
    ...
    >
      <h3 className="font-semibold text-sm sm:mb-2 mr-3 sm:mr-0 bg-primary rounded-full text-white px-[0.7rem] py-[0.6rem]">{day}</h3>
...
export function WeeklySchedule() {
  return (
    <Card className="p-2 sm:p-4 w-full max-w-7xl mx-auto overflow-x-hidden">
