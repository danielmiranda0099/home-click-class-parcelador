  ...
  return (
    <div className="grid grid-cols-2 lg:grid-cols-5 gap-4">
      ...
      <Card>
        <CardHeader className="pb-2">
          <CardTitle className="text-sm font-medium">
            Egresos Profesor {year}
          </CardTitle>
        </CardHeader>
        <CardContent>
          <div className={`text-lg lg:text-2xl font-bold text-red-400`}>
            -{formatCurrency(balance.expenseTeacher)}
          </div>
        </CardContent>
      </Card>
      <Card>
        ...
        <CardContent>
          <div className={`text-lg lg:text-2xl font-bold text-red-400`}>
            -{formatCurrency(balance.expenseOther)}
          </div>
        </CardContent>
      </Card>
      <Card>
      ...
      <Card>
        ...
        <CardContent>
          <div
            className={`text-lg lg:text-2xl font-bold  ${balance.balance >= 0 ? "text-blue-400" : "text-red-400"}`}
          >
